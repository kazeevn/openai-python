...
class Choice(BaseModel):
    ...
    # "thinking_end" and "error" are added for jina-deepsearch-v1
    finish_reason: Optional[Literal["stop", "length", "tool_calls", "content_filter", "function_call", "thinking_end", "error"]] = None
